...
class ConfigurationInterface{
 public:
  ...
  virtual bool Get(const string &property, string &value) const = 0;
  //Set a string value to the key(property).
  virtual void Set(const string &property, string value) = 0;
  //Get integer value by the key(property), 
  //return false if the key is not exist.
  virtual bool GetInt(const string &property, int &value) const = 0;
  //Set a integer value to the key(property).
  virtual void SetInt(const string &property, int value) = 0;
