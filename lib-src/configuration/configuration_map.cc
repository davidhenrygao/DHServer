...
bool ConfigurationMap::Get(const string &property, string &value) const {
...
bool ConfigurationMap::GetInt(const string &property, int &value) const {
  std::map<string, string>::const_iterator k_iter = cfg_map_.find(property);
  if (k_iter != cfg_map_.end()) {
...
void ConfigurationMap::Set(const string &property, string value) {
  cfg_map_[property] = value;
}

void ConfigurationMap::SetInt(const string &property, int value) {
